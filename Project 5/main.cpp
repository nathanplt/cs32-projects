...
const std::string PATH = "/Users/nathan/CS32 Projects/Project 5/Project 5/";
...
int main(int argc, char* argv[]) {
    ...
    else
    {
        ...
        param_filename = PATH + param_filename;
    }
    ...
    if (!airport_db.load_airport_data(PATH + "airports.txt")) {
